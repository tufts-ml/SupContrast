...
2. `SINCERELoss` for supervised learning **without multiple augmentations** of the images.
3. `InfoNCELoss` for **self-superviesd learning** with multiple augmentations of the images.
