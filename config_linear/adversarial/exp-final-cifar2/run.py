...
checkpoint_dict = {
    "best_val_separation_t1": [
        Path(
            "/cluster/tufts/hugheslab/mlao01/Git/SupContrast/save/SupCon/exp-final-cifar2/cifar2_models/SINCERE_cifar2_resnet50_lr_0.36238983183884776_decay_0.0001_bsz_512_temp_0.12_trial_0_cosine_warm_2025_12_21-03_36_45/last.pth",
        ),
        Path(
            "/cluster/tufts/hugheslab/mlao01/Git/SupContrast/save/SupCon/exp-final-cifar2/cifar2_models/SupCon_cifar2_resnet50_lr_0.19036539387158782_decay_0.0001_bsz_512_temp_0.12_trial_0_cosine_warm_2025_12_21-01_14_28/last.pth",
        ),
    ],
}
...
if PRJ_HEAD:
    SUB_DIR = f"exp-final-cifar2/january/{DATASET}/size-{IMAGE_SIZE}/{CHECKPOINT_NAME}/{EPOCH_NAME}/"
else:
    SUB_DIR = f"exp-final-cifar2/january/{DATASET}/size-{IMAGE_SIZE}/{CHECKPOINT_NAME}_wo_projection_head/{EPOCH_NAME}/"
