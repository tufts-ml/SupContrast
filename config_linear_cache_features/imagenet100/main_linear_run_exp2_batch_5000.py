...
checkpoint_dict = {
    ## exp2
    "resnet-18-imagenet-100-32x32-batch-100": [
        Path(
    ...
    "resnet-18-imagenet-100-32x32-batch-5000": [
        Path(
...
CHECKPOINT_NAME = "resnet-18-imagenet-100-32x32-batch-5000"

SUB_DIR = f"exp2/{DATASET}/size-{IMAGE_SIZE}/{CHECKPOINT_NAME}/"
...
search_dict = {
    ...
    "--epochs": 50,
    "--weight_decay": 1e-4,
    # 15 lr on log scale from 0.1 to 80
    "--learning_rate": np.logspace(np.log10(0.01), np.log10(20), 15).tolist(),
    "--valid_split": 0.1,
    "--size": IMAGE_SIZE,
    "--dataset": DATASET,
